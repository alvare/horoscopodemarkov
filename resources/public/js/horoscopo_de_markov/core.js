...
document.write((function (){var tokens = horoscopo_de_markov.markov.tokenize_str.call(null,horoscopo_de_markov.core.geminis);var prefix_length = 2;var length = 40;var model = horoscopo_de_markov.markov.build_markov_model_sentence.call(null,tokens,prefix_length);var prefix = new cljs.core.Keyword(null,"head","head",1017102674).cljs$core$IFn$_invoke$arity$1(model);var chain = horoscopo_de_markov.markov.build_markov_chain_sentence.call(null,model);return console.log(cljs.core.clj__GT_js.call(null,chain));
})());
