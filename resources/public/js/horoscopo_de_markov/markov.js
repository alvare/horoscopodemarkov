...
var G__4753 = cljs.core.assoc.call(null,accum,pfx,cljs.core.conj.call(null,cljs.core.get.call(null,accum,pfx,cljs.core.PersistentVector.EMPTY),sfx));
var G__4754 = cljs.core.next.call(null,token_groups);
accum = G__4753;
token_groups = G__4754;
continue;
}
} else
{return accum;
...
var G__4755 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"heads","heads",1113055749),cljs.core.assoc.call(null,heads,pfx,cljs.core.conj.call(null,cljs.core.get.call(null,heads,pfx,cljs.core.PersistentVector.EMPTY),sfx)),new cljs.core.Keyword(null,"bodys","bodys",1107816067),cljs.core.merge_with.call(null,cljs.core.concat,bodys,horoscopo_de_markov.markov.build_markov_model.call(null,g,prefix_length))], null);
var G__4756 = cljs.core.next.call(null,token_groups);
accum = G__4755;
token_groups = G__4756;
continue;
}
} else
{return accum;
