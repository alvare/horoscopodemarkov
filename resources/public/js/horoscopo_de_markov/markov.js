...
horoscopo_de_markov.markov.process_tail = (function process_tail(tokens,prefix_length){var accum = cljs.core.PersistentArrayMap.EMPTY;var token_g = cljs.core.partition.call(null,(prefix_length + 1),1,tokens);while(true){
...
var G__4926 = cljs.core.merge_with.call(null,horoscopo_de_markov.markov.concat_v,accum,cljs.core.PersistentArrayMap.fromArray([pfx,cljs.core.PersistentVector.fromArray([sfx], true)], true));
var G__4927 = cljs.core.next.call(null,token_g);
accum = G__4926;
token_g = G__4927;
continue;
}
